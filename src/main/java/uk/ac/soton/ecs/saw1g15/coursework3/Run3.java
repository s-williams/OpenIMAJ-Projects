...
public class Run3 {
	...
	protected static String modelType = "AlexNet"; // LeNet, AlexNet
...
<<<<<<< HEAD
			 ...
			 * limits on format - pathFilter = define additional file load
			 * filter to limit size and balance batch content
			 **/
			ParentPathLabelGenerator labelMaker = new ParentPathLabelGenerator();
			System.out.println(System.getProperty("user.dir") + "======" + "/data/training/");
			File mainPath = new File(System.getProperty("user.dir"), "/data/training/");
			...
			/**
			 * Data Setup -> transformation - Transform = how to tranform images
			 * and generate large dataset to train on
			 **/
			...
			/**
			 * Data Setup -> normalization - how to normalize images and
			 * generate large dataset to train on
			 **/
			DataNormalization scaler = new ImagePreProcessingScaler(0, 1);

			// Uncomment below to try AlexNet. Note change height and width to
			// at least 100
			// MultiLayerNetwork network = new AlexNet(height, width, channels,
			// numLabels, seed, iterations).init();
			...
			network.setListeners((IterationListener) new StatsListener(statsStorage),
			...
			// Example on how to get predict results with trained model. Result
			// for first example in minibatch is printed
			dataIter.reset();
...
>>>>>>> 1d767f0a56f3dcbb36f3afd7101a14f7c106b64f
	...
	public MultiLayerNetwork alexnetModel() {
		...
		MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder().seed(seed)
				...
				.updater(new Nesterovs(0.9)).iterations(iterations)
				...
				.lrPolicySteps(100000).regularization(true).l2(5 * 1e-4).list()
				.layer(0,
...
//		try {
//		    Loader.load(Nd4j.class);
//		} catch (UnsatisfiedLinkError e) {
//		    String path = Loader.cacheResource(Nd4j.class, "windows-x86_64/jniNd4jCpu.dll").getPath();
//		    new ProcessBuilder("C:/Users/Admin/Downloads/depends22_x64/depends.exe", path).start().waitFor();
//		}
